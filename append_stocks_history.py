...
def get_last_date_in_history():
    ...
    try:
        df = pd.read_csv('/Users/sw/Desktop/stock/rs-log/output/rs_stocks_historical.csv', 
...
def append_new_stocks_data():
    ...
    historical_path = Path('/Users/sw/Desktop/stock/rs-log/output/rs_stocks_historical.csv')
